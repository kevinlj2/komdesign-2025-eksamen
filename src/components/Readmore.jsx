...
export default function Readmore({ children }) {
  ...
  return (
    <div className="max-w-prose background-white pt-20 pb-20">
      <p>
        <span className="float-left text-[64px] leading-[66px] mr-[6px] mb-[5px]">N</span>orske myndigheter har hatt et viktig mål veldig lenge når det kommer
