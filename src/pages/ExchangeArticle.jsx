  ...
  return (
    <>
      <section className="relative w-screen h-screen overflow-hidden">
        <img
          src="./assets/images/airplane.gif"
          alt="Utveksling"
          className="absolute inset-0 w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-black/20"></div>
        <div className="relative z-10 flex flex-col h-full text-right mx-2 px-60 py-40">
          <h1 className="text-5xl font-semibold text-black drop-shadow-lg">
            Jorda rundt{" "}
          </h1>
          <p className="text-xl text-black mt-2 drop-shadow-md">
            studenter på utveksling
          </p>
          <span className="mt-4 text-sm text-gray-700 italic tracking-wide">
      ...
      <section className="w-full flex flex-col items-center ">
        <div className="w-full max-w-[800px] text-center space-y-6 px-4">
          ...
          <p>
            Dette inkluderer da Anneli Lirhus Evertsen som dro på utveksling til
            Sør-Korea.{" "}
          </p>
          <img
          ...
          <p>
            ...
            ved Handelshøyskolen BI. Evertsen sin utvekslingsskole endte opp med
            å studere ved Woosong University, i Endicott College of
            International Studies. Woosong University er et universitet som er i
            Daejeon, landets femte største storby. Skolen spesialiserer seg på
            IT utdanning og fremmedspråk. Woosong rangerer som nummer 1 i
            Sør-Korea for International Outlook, og som et universitet rangerer
            som nummer 30 i hele landet.{" "}
          </p>

          <p>
            Anneli har dette å si om utvekslingen sin, «jeg hadde det utrolig
          ...
          <p>Det er også negative faktorer i å dra bort. </p>

          <div className="max-w-md bg-white shadow-lg rounded-xl p-6 border border-gray-200 ">
            <h2 className="text-xl font-semibold mb-4 text-gray-800">
              FAKTABOKS: Hva hindrer studentene i å reise ut?
            </h2>
          ...
          <p>
            ...
            Jennifer forklarer at «min familie fokuserte på det faktumet at hvis
          ...
          <p>
            «Hvis min Høgskole hadde gitt mer konkret informasjon, faktisk tatt
            ...
            det for utvekslingsopplevelsen» forteller Jennifer.{" "}
          </p>
          ...
          <p>
            ...
            høgskoler, «… det er totalt svikt fra institusjonenes side …
            betydelig andel av studentene ikke mottar god nok informasjon, og
            faktisk ikke opplever mulighet til å dra på utveksling». Det er
          ...
          <p>
            Høgskolen i Østfold har en rådgiver for internasjonalisering,
            Rebecca Dawn Smith Norvang.
          </p>
          <img
          ...
          <p>
            ...
            ikke dette nok, der Norvang forklarer «studenter må ha tiltrekkende
            tilbud, både akademisk, praktisk og økonomisk. Utveksling må bli
            enda lettere å gjennomføre dersom vi kan oppnå 50%».{" "}
          </p>
          ...
          <p>
            Er du interessert i å dra på utveksling? Her er en liste over tre
            ting som kan hjelpe deg i å starte prosessen: ANSA – organisasjon
            for norske studenter i utlandet, medlemskap og forsikring Erasmus+ -
            utdanningsprogram innenfor EU Høgskolen i Østfold eller studiestedet
            ...
            innsikt til studieopphold Lånekassen – finn ut om stipend og lån du
            kan få mens du er på utveksling{" "}
          </p>
        </div>
      </section>
    </>
